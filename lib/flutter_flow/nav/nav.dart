      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => CategoryDetailWidget(
            ...
            categoryColor: params.getParam(
              'categoryColor',
              ParamType.Color,
            ),
            categoryIcon: params.getParam(
              'categoryIcon',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: FullMotivationViewWidget.routeName,
          path: FullMotivationViewWidget.routePath,
          builder: (context, params) => FullMotivationViewWidget(
            motivationText: params.getParam(
              'motivationText',
              ParamType.String,
            ),
            id: params.getParam(
            ...
            motivationTitle: params.getParam(
              'motivationTitle',
              ParamType.String,
            ),
            categoryName: params.getParam(
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'Vault') : VaultWidget(),
        )
