...
abstract class FlutterFlowTheme {
  ...
  late Color royalGold;
  late Color softGrey;
  late Color deepNavy;
  late Color white;
  late Color gradientBg1;
  late Color gradientBg2;
  late Color dividerColor;
  late Color subHeadingColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF0A0F2C);
  ...
  late Color midnightBlue = const Color(0xFF0A0F2C);
  late Color royalGold = const Color(0xFFD4AF37);
  late Color softGrey = const Color(0xFFF2F2F2);
  late Color deepNavy = const Color(0xFF030617);
  late Color white = const Color(0xFFFFFFFF);
  late Color gradientBg1 = const Color(0xFF14276F);
  late Color gradientBg2 = const Color(0xFF112156);
  late Color dividerColor = const Color(0x4CD4AF37);
  late Color subHeadingColor = const Color(0xFFF9E5B6);
  late Color textColor = const Color(0xFFCFCFCF);
  late Color header2 = const Color(0xFFFFD347);
  late Color offWhite = const Color(0xFFE6E6E6);
}
